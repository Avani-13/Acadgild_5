...
public class Driver1 {
	...
	public static void main(String[] args) throws Exception {
    	    ...
    	    if (args.length != 2) {
    	        System.err.println("Driver1 <input path> <output path>");
    	        System.exit(-1);
    	      }
          ...
          //Some std outs for the counters to come on the console
            ...
            Counter invalidRecordCount = counters.findCounter(Driver1.COUNTERS.INVALID_RECORD_COUNT);
